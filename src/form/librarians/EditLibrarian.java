...
public class EditLibrarian extends javax.swing.JFrame {
    ...
    public EditLibrarian(String ID) {
        this.ID = ID;
        initComponents();
        fetchLibrarianById();
    }
    ...
    private void initComponents() {
        ...
        updateLibrarianButton = new javax.swing.JButton();
        ...
        updateLibrarianButton.setBackground(new java.awt.Color(0, 102, 102));
        updateLibrarianButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        updateLibrarianButton.setForeground(new java.awt.Color(255, 255, 255));
        updateLibrarianButton.setText("Xác nhận");
        updateLibrarianButton.setBorder(null);
        updateLibrarianButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                updateLibrarianButtonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                updateLibrarianButtonMouseExited(evt);
            }
        });
        updateLibrarianButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateLibrarianButtonActionPerformed(evt);
            }
        });
        jPanel2.add(updateLibrarianButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 570, 180, 50));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Cập nhật nhân viên");
        ...
        jPanel9.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, -1, -1));
        ...
        jPanel9.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, -1, -1));
        ...
        jPanel9.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 500, 30));
        ...
        jPanel9.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, -1, -1));

        password.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        password.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 153, 153)));
        jPanel9.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 360, 500, 30));

        jPanel2.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 680, 420));
    ...
    private void updateLibrarianButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateLibrarianButtonMouseEntered
        Color color = new Color(0,51,51);
        updateLibrarianButton.setBackground(color);
    }//GEN-LAST:event_updateLibrarianButtonMouseEntered

    private void updateLibrarianButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateLibrarianButtonMouseExited
        Color color = new Color(0,102,102);
        updateLibrarianButton.setBackground(color);
    }//GEN-LAST:event_updateLibrarianButtonMouseExited
    ...
    private void updateLibrarianButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateLibrarianButtonActionPerformed
        try {
            int editID = Integer.parseInt(this.ID);
            ...
            if (UserName.isEmpty() || PassWord.isEmpty() || FirstName.isEmpty() || LastName.isEmpty()
                ...
                if (uniqueCheck) {
                    if (!isValidEmail(Email)) {
                        ...
                        PreparedStatement librarianUpdate = c.prepareStatement("UPDATE librarian SET firstname = ?, lastname = ?, username = ?, password = ?, email = ?, phone = ?, address = ?, level= ? WHERE id = ?");
                        librarianUpdate.setString(1, FirstName);
                        librarianUpdate.setString(2, LastName);
                        librarianUpdate.setString(3, UserName);
                        librarianUpdate.setString(4, PassWord);
                        librarianUpdate.setString(5, Email);
                        librarianUpdate.setString(6, Phone);
                        librarianUpdate.setString(7, Address);
                        librarianUpdate.setInt(8, Level);
                        librarianUpdate.setInt(9, editID);
                        librarianUpdate.executeUpdate();
    ...
    }//GEN-LAST:event_updateLibrarianButtonActionPerformed
    ...
    private javax.swing.JButton updateLibrarianButton;
